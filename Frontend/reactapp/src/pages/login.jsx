    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-green-50">
      ...
      >
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 md:mb-4 text-center">
          Welcome to <span className="">FloraX</span>
        </h1>
      ...
      >
        <div className="max-w-md mx-auto w-full">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2 text-center">Login</h2>
          <p className="text-center text-gray-600 mb-6 md:mb-8 text-sm md:text-base">Sign in to your account</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-12 py-3 rounded-lg border ${errors.password ? "border-red-500" : "border-gray-300"} focus:outline-none focus:border-green-600 focus:ring-2 focus:ring-green-100 transition text-sm md:text-base`}
